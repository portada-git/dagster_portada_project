...
so = platform.system()
if so == "Darwin":
    cfg_path = os.getenv("DATA_LAYER_CONFIG", "dagster_portada_project_tests/delta_data_layer_config_linux.json")
else:
    cfg_path = os.getenv("DATA_LAYER_CONFIG", "dagster_portada_project_tests/delta_data_layer_config_mac.json")

redis_host = os.getenv("REDIS_HOST", "localhost")
redis_port = os.getenv("REDIS_PORT", "6350")
